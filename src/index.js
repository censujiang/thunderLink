      ...
      return ".avi|.wmv|.mpeg|.mp4|.mov|.mkv|.flv|.f4v|.m4v|.rmvb|.rm|.3gp|.dat|.ts|.mts|.vob".indexOf(
        ...
        : ".mp3|.aac|.aiff|.amr|.m4p|.wav|.ogg|.raw|.dv".indexOf(n) > -1
          ...
          : ".txt|.docx|.pptx|.xlsx".indexOf(n) > -1
            ...
            : ".exe|.ipa|.apk|.dmg|.bin|.pkg|.bat|.cmd|.com|.msi|.ins".indexOf(
                  n,
                ) > -1
    ...
    var c = null,
      F = {
        ...
        generateTemplateForNotInstallOrNeedToUpate: function (e) {
          ...
          "need_to_install_xmp" === r
            ? (F =
                '<div class="xl_wp_downmkv"><p class="xl_tip_downmkv" id="js_xl_manual_download_prompt" style = "font-size: 12px">\u5982\u60a8\u5df2\u5b89\u88c5\u8fc5\u96f7\u6216\u8005\u8fc5\u96f7\u5f71\u97f3<a href="javascript:;" class="link" id="js_xl_manual_lunach_xmp">\u70b9\u51fb\u8fd9\u91cc\u5f00\u59cb\u64ad\u653e</a></p>  <div class="xl_downmkv_tip">                 <p style = "font-size: 12px">\u5982\u672a\u5b89\u88c5\u8fc5\u96f7\u6216\u8fc5\u96f7\u5f71\u97f3<br>\u70b9\u51fb\u5c06\u65e0\u6548</p>               </div>            </div> ')
            : "need_to_update_on_win" !== r &&
              (F =
                !1 === i && !0 !== s
                  ...
                  : '<div class="xl_wp_downmkv">              <p class="xl_tip_downmkv" style = "font-size: 12px">\u5982\u60a8\u5df2\u7ecf\u5b89\u88c5\u8fc5\u96f7<a style = "font-size: 12px" href="' +
                    C +
                    '" class="js-xl-link link" id="js_xl_manual_download_btn">\u70b9\u51fb\u8fd9\u91cc\u5f00\u59cb\u4e0b\u8f7d</a></p>              <div class="xl_downmkv_tip">                 <p style = "font-size: 12px">\u5982\u672a\u5b89\u88c5\u6700\u65b0\u7248\u8fc5\u96f7<br>\u70b9\u51fb\u5c06\u65e0\u6548</p>               </div>            </div> ');
          var d = "",
            h = 0;
          if (E)
            (h = 408),
              ...
              : v.createRange &&
                (l = function (e, t) {
                  ...
                  return (
                    ...
                    i.setEnd(t, 0),
                    0 ===
                      (e = n.compareBoundaryPoints(Range.START_TO_END, i)) &&
                      (E = !0),
                    e
                  );
                }),
